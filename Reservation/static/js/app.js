 				   ...
 				   for (i = 0; i < resp.count; i++)
                                   {
                                       ...
                                       res_time = resp.entries[i].res_time;
                                        $("#viewreserve").append(viewreserve(diner,cus_name,cus_num,attendees,res_date,res_time));
                                   }
 				} else
 				{
                                        $("#viewreserve").html("");
...
function viewreserve(diner,cus_name,cus_num,attendees,res_date,res_time)
    {
           return '<tr>'+
                 '<td>' +diner+ '</td>' +
                 '<td>' +cus_name+ '</td>' +
